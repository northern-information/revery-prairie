...
export const DialogBox = ({ characterName, portrait, line, typingIndex, isAngel }: DialogBoxProps) => (
  <div className="text-text fixed top-1/2 right-48 left-0 z-30 mx-auto flex max-h-[140px] min-h-[80px] w-[65vw] max-w-[min(800px,calc(100vw-12rem-1rem))] -translate-y-1/2 items-start gap-4 overflow-hidden bg-black/85 px-6 py-4 font-mono text-xs">
    {portrait && (
      <img
        src={portrait}
