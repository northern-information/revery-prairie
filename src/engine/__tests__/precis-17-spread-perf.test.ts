// Precis #17 — spread + pollination performance gate.
//
// Approach (chosen during precis-17 implementation, see the strategy
...
describe('precis-17 spread + pollination perf gate', () => {
