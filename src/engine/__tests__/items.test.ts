...
describe('getDefinition', () => {
  it('returns correct definition for bee', () => {
    ...
    expect(def.iconColor).toBe('#FFD700')
    expect(def.category).toBe(ItemCategory.Critter)
  ...
  it('returns correct definition for clover', () => {
    ...
    expect(def.icon).toBe('%')
    expect(def.iconColor).toBe('#50C878')
    expect(def.category).toBe(ItemCategory.Flora)
    expect(def.weight).toBe(1)
    expect(def.shape).toEqual([[true]])
  })

  it('returns correct definition for soil_sampler', () => {
    const def = getDefinition('soil_sampler')
    expect(def.id).toBe('soil_sampler')
    expect(def.name).toBe('Soil Sampler')
    expect(def.icon).toBe('\u2637')
    expect(def.iconColor).toBe('#8B7355')
