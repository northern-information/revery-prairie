// Big Bluestem (Andropogon gerardii) — tall grass flora species.
//
...
// per precis #1 — the broader pollinator routes are deferred to precis #7.
// Tall grass tiles persist or die per the shared six-stage lifecycle but do
