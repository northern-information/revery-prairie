...
- `docs/design.md` exists in-repo as the canonical design text.
...
- **Don't port breed-spike's Mendelian hex-grid math.** It rewards engineering. The doctrine wants folk ecology, not optimization.
