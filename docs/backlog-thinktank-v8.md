...
- **The cast of angels is exhaustive.** Every cosmological actor the prairie has gets an angel — flora (clover, wildflower, tall grass, egregore), pollinators (bees), weather (rain, fire, lightning), cosmos (meteorites), geology (sundering). Each personifies a substrate that already exists or is locked in doctrine. (Round 2.)
...
- **The cast is exhaustive.** Every cosmological actor the prairie has gets an angel: Rain, Bees, Clover (existing); Wildflower, Tall Grass, Fire, Lightning, Egregore, Sundering, Meteorites (new). Each personifies a substrate that already exists or is locked in doctrine.
